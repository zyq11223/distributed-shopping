package pers.yhf.seckill.result;
...
public class CodeMsg {
	...
	public static CodeMsg REPEAT_SECKILL = new CodeMsg(500501,"不允许重复秒杀");
	public static CodeMsg MIAOSHA_FAIL = new CodeMsg(500502, "秒杀失败");
	public static CodeMsg QUEUE_SECKILL = new CodeMsg(500503,"正在排队中");
